...
&#x20;[#objectbox-for-java-advanced-setup](advanced-setup#objectbox-for-java-advanced-setup "mention")&#x20;

&#x20;[#objectbox-for-flutter-dart-advanced-setup](advanced-setup#objectbox-for-flutter-dart-advanced-setup "mention")

## ObjectBox for Java - Advanced Setup

This page assumes you have [added ObjectBox ](../getting-started)to your project.
...
<Tabs>
<TabItem value="androidkotlin" label="Android (Kotlin)">
...
<TabItem value="androidjava" label="Android (Java)">
...
<TabItem value="jvmjava" label="JVM (Java)">
...
<TabItem value="jvmkotlin" label="JVM (Kotlin)">
