...
The setup and writing tests is identical to writing unit tests that run on the local JVM for Android, see [android-local-unit-tests.md](android/android-local-unit-tests "mention").