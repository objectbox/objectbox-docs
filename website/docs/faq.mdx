...
<div className="custom-nav-card">
  <a href="/troubleshooting" className="custom-nav-card-link">
    <div className="custom-nav-card-content">
      <h3 className="custom-nav-card-title">Troubleshooting</h3>
      <p className="custom-nav-card-description">Learn more about troubleshooting</p>
    </div>
