...
<Tabs>
<TabItem value="javakotlinandroid" label="Java/Kotlin (Android)">
...
```java title="/app/build.gradle(.kts)"
...
:::info
If you encounter any problems in this or later steps, check out the [FAQ](faq) and [Troubleshooting](troubleshooting) pages.
:::
...
<TabItem value="javakotlinjvm" label="Java/Kotlin (JVM)">
...
<TabItem value="dartnative" label="Dart Native">
...
[Support for many property types](advanced/custom-types) is already built-in, but almost any type can be stored [with a converter](advanced/custom-types#convert-annotation-and-property-converter).

For more details about entities, like how to create an index or a relation, check the [entity-annotations.md](entity-annotations "mention") page.

You can also [learn more about the ObjectBox model](advanced/meta-model-ids-and-uids).
...
**To rename entities or properties, change the type of a property** and more details in general see [data-model-updates.md](advanced/data-model-updates "mention").
:::
...
<Tabs>
<TabItem value="javakotlin" label="Java/Kotlin">
...
To change the package of the `MyObjectBox` class, see the annotation processor options on the [advanced-setup.md](advanced/advanced-setup "mention") page.

</TabItem>
<TabItem value="flutterdartnative" label="Flutter/Dart Native">
...
To customize the directory where generated files are written see [advanced-setup.md](advanced/advanced-setup "mention").
...
To change the model file path, see [advanced-setup.md](advanced/advanced-setup "mention").
...
:::tip
The model file also enables you to keep data [when renaming entities or properties](advanced/data-model-updates) or to [resolve conflicts](https://docs.objectbox.io/advanced/meta-model-ids-and-uids) when two of your developers make changes at the same time.
:::
...
<Tabs>
<TabItem value="javaandroid" label="Java (Android)">
...
:::warning
If you encounter `UnsatisfiedLinkError` or `LinkageError` on the build call, see [App Bundle, split APKs and Multidex](android/app-bundle-and-split-apk) for solutions.
:::
...
<TabItem value="kotlinandroid" label="Kotlin (Android)">
...
**query:** Starts building a query to return objects from the box that match certain conditions. See [queries](queries) for details.
...
For a detailed explanation see the page on [Object IDs](advanced/object-ids).
...
For more details check the separate [transaction documentation](transactions).
...
* Learn about [Queries](queries) and [Relations](relations).
* Learn [how to write unit tests](android/android-local-unit-tests).
* To enable debug mode and for advanced use cases, see the [advanced-setup.md](advanced/advanced-setup "mention") page.