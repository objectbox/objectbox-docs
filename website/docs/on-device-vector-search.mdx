...
:::info
**Performance note:** for inserting multiple objects at once, wrap a [transaction](transactions) around the `put` commands.
:::
...
![](/img/assets/data-model-vectordb.png)
