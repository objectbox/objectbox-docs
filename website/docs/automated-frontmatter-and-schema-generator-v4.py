...
class FrontmatterAndSchemaGeneratorV4:
    def __init__(self, project_name="ObjectBox", language="Java, Kotlin, Flutter / Dart", base_url="https://docs.objectbox.io/"):
        ...
        self.language_keywords = {
            ...
            "Go": ["go", "golang"],
            "C++": ["c++", "cpp", "cmake"],
            "Java": ["java", "android", "mobile database"],
            "Dart": ["dart", "flutter", "android", "iOS", "cross-platform"],
            "Kotlin": ["kotlin", "android", "mobile database"],
            "Python": ["python"]
        }
